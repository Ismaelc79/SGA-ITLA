...
{
    public sealed class CreateTarjetaRecargableDtoValidator : AbstractValidator<CreateTarjetaRecargableDto>
    {
        public CreateTarjetaRecargableDtoValidator()
        {
            ...
            RuleFor(x => x.FechaVigenteInicio)
                ...
                .LessThan(x => x.FechaVigenteFin)
                    .WithMessage("La fecha de inicio no puede ser posterior a la fecha de fin de vigencia");
